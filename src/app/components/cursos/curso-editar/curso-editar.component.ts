...
export class CursoEditarComponent {
  ...
  finalizarCadastroMatricula(matricula: Matricula) {
    this.apresentarMensagemMatriculaCadastroComSucesso(matricula)
  ...
  apresentarMensagemMatriculaCadastroComSucesso(matricula: Matricula) {
    this.messageService.add({
      detail: `Matricula cadastro com sucesso para o aluno '${matricula.aluno.nome}'`,
      severity: "success"
    });
  }
  ...
  private apresentarMensagemMatriculaApagada() {
    this.messageService.add({
      severity: 'success',
      summary: 'Sucesso',
      detail: 'matricula removido com sucesso',
    });
    this.carregarMatriculas();
  }
}
