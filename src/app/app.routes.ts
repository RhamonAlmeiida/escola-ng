...
import { FormacaoCadastrarComponent } from './components/formacoes/formacao-cadastro/formacao-cadastrar.component';
import { FormacaoListarComponent } from './components/formacoes/formacao-lista/formacao-listar.component';
...
export const routes: Routes = [
    ...
    {path: "formacoes", component: FormacaoListarComponent},
    {path: "formacoes/cadastro", component: FormacaoCadastrarComponent},
];
